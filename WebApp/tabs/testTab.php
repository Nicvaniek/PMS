                ...
                <li>
                    ...
                    <div class='collapsible-body'>
                        ...
                        <table>
                            ...
                            <?php
                                $sql ="SELECT * FROM Renovations WHERE PropertyID = " . $propertyRow['ID'] ." ORDER BY ID";
                            ...
                            <?php 
                                ...
                                <tr>
                                    ...
                                    <td><strong>---</strong></td>
                                    <td><strong>---</strong></td>
                                    <?php $sql ="SELECT SUM(`Cost` * `Quantity`) SumProduct FROM Renovations WHERE PropertyID = " . $propertyRow['ID'];
                                        $result = mysqli_query($conn, $sql);
